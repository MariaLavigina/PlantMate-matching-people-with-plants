        ...
        <div className="pl-8 md:pl-12 lg:pl-16 xl:pl-20 2xl:pl-28 pr-4 sm:pr-6 lg:pr-8">
          <div className="flex items-center h-16">
            ...
            <div className="hidden md:flex items-center space-x-8">
              <Link to="/" className="text-[#E2CFFA] hover:text-[#65F0CD] font-medium">Home</Link>
              <Link to="/about" className="text-[#E2CFFA] hover:text-[#65F0CD] font-medium">About Me</Link>
              <Link to="/contact" className="text-[#E2CFFA] hover:text-[#65F0CD] font-medium">Contact Me</Link>
              <Link to="/quiz" className="text-[#E2CFFA] hover:text-[#65F0CD] font-medium">Take Quiz</Link>
          ...
          {isOpen && (
            <div className="md:hidden pb-4 flex flex-col space-y-4">
              <Link to="/" onClick={() => setIsOpen(false)} className="text-[#E2CFFA] hover:text-[#65F0CD] font-medium">Home</Link>
              <Link to="/about" onClick={() => setIsOpen(false)} className="text-[#E2CFFA] hover:text-[#65F0CD] font-medium">About Me</Link>
              <Link to="/contact" onClick={() => setIsOpen(false)} className="text-[#E2CFFA] hover:text-[#65F0CD] font-medium">Contact Me</Link>
              <Link to="/quiz" onClick={() => setIsOpen(false)} className="text-[#E2CFFA] hover:text-[#65F0CD] font-medium">Take Quiz</Link>
              <button onClick={() => setAuthModal("register")} className="text-[#65F0CD] hover:text-[#E2CFFA] font-medium">Register</button>
              <button onClick={() => setAuthModal("login")} className="text-[#65F0CD] hover:text-[#E2CFFA] font-medium">Login</button>
            </div>
          )}
